...
class WoolworthsScraper extends SaleScraper
{
    ...
    public function __construct($arg)
    {
        ...
        $this->parse_catalog('https://www.woolworths.co.za/cat/Homeware/Bedroom/_/N-1z13s0l');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Homeware/Bathroom/_/N-1z13s0e');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Homeware/Bathroom/_/N-1z13s0e');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Homeware/Dining/_/N-1z13rzy');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Homeware/Kitchen/_/N-1z13s0a');
