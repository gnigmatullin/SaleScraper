...
class WoolworthsScraper extends SaleScraper
{
    ...
    public function __construct($arg)
    {
        ...
        $this->parse_catalog('https://www.woolworths.co.za/cat/Beauty/Fragrance/_/N-1z13ryf');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Beauty/Skincare/_/N-1z13ryp');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Beauty/Makeup/_/N-1z13ryl');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Beauty/Bath-Body/_/N-1z13rz3');
