...
/**
 * @file dc.php
 * @brief File contains https://www.jacklemkus.com website scraper
 */
 ...
 */
class JacklemkusScraper extends SaleScraper
{
    ...
    {
        parent::__construct('Jacklemkus', 'ZAR', $arg);
    ...
    private function parse_catalog($url)
    {
        ...
        $this->category_name = $this->get_node_value('//strong/h1');
        ...
        // Get pages count
        $items_count = $this->get_node_value('//div[ @class = "amount right hide" ]');
        if (!$items_count)
        {
...
$scraper = new JacklemkusScraper($argv);