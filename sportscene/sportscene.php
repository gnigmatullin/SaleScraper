...
/**
 * @file dc.php
 * @brief File contains https://www.sportscene.co.za/ website scraper
 */
 ...
 */
class SportsceneScraper extends SaleScraper
{
    ...
    {
        parent::__construct('Sportscene', 'ZAR', $arg);
    ...
    private function parse_categories()
    {
        ...
        $this->apiurl = 'https://www.sportscene.co.za/search/ajaxResultsList.jsp?N={id}&Ns=availability|1||daysAvailable|1||sortPriority|0&Nrpp=15&page=1&No=0&baseState={id}';
        // Get all categories
...
$scraper = new SportsceneScraper($argv);