...
/**
 * @file superga.php
 * @brief File contains https://www.superga.co.za website scraper
 */
 ...
 */
class SupergaScraper extends SaleScraper
{
    ...
    {
        parent::__construct('Superga', 'ZAR', $arg);
    ...
    {
        $categories = [
            'ladies/platforms.html',
            'ladies/sport.html',
            'ladies/fashion.html',
            'ladies/classics.html',
            'ladies/leather.html',
            'mens/sport.html',
            'mens/leather.html',
            'mens/classics.html',
    ...
    private function parse_catalog($url)
    {
        ...
        $this->category_name = $this->get_node_value('//h1[ @id = "page-title-heading" ]');
        ...
        // Get pages count
        $pages_count = $this->get_node_value('//ul[ @class = "items pages-items" ]/li[ last()-1 ]/a/span[2]/text()');
        if (!$pages_count)
        {
...
$scraper = new SupergaScraper($argv);