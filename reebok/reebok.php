...
/**
 * @file reebok.php
 * @brief File contains https://www.reebok.co.za website scraper
 */
 ...
 */
class ReebokScraper extends SaleScraper
{
    ...
    {
        parent::__construct('Reebok', 'ZAR', $arg);
    ...
    private function parse_catalog($url)
    {
        ...
        // Get pages count
        $pages_count = $this->get_node_value('//div[ @class = "reebok-pagination pull-right" ]/div[3]');
        if (!$pages_count)
        {
...
$scraper = new ReebokScraper($argv);