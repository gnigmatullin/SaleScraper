...
class WoolworthsScraper extends SaleScraper
{
    ...
    public function __construct($arg)
    {
        ...
        $this->parse_catalog('https://www.woolworths.co.za/cat/Kids/Girls-2-15-/_/N-1z13s2r');
        $this->parse_catalog('https://www.woolworths.co.za/cat/Kids/Boys-2-15-/_/N-1z13s2f');
